...
/// App-wide color appearance override (Settings → 浅色 / 深色 / 跟随系统).
...
final class AppSettings: ObservableObject {
    ...
    init(defaults: UserDefaults = .standard, appliesSystemAppearance: Bool = true) {
        ...
        // Keep the stored style identifier stable while presenting it as Cards.
        ...
        defaults.set(refreshIntervalStorage, forKey: Keys.refreshInterval)
    ...
    var refreshInterval: Double {
        ...
        set {
            ...
            guard refreshIntervalStorage != value else { return }
